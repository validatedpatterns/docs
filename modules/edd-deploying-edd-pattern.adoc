...
. Customize the `values-global.yaml` for your deployment. For a description of each field, see link:/learn/values-global-configuration/[Global configuration reference].
+
[source,terminal]
----
