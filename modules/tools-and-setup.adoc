...
=== Preview the documentation using a container

* To build the documentation locally, you can run `make serve` from the docs git repository folder and then point your browser to `localhost:4000`. This requires `make` and `podman` to be installed.
