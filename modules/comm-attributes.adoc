...
:archived-tier-first: Validated Patterns Archived tier
...
:amdqna-pattern: OPEA QnA chat accelerated with AMD Instinct pattern
...
:rhoai-pattern: Red Hat OpenShift AI pattern
// Associated products
...
:rhacm: Red{nbsp}Hat Advanced Cluster Management for Kubernetes
:rhacs: Red{nbsp}Hat Advanced Cluster Security for Kubernetes
:rhocp: Red{nbsp}Hat OpenShift Container Platform
:rhodf: Red{nbsp}Hat OpenShift Data Foundations
