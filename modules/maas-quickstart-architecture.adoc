...
Manages sensitive credentials including htpasswd user passwords. The {solution-name-upstream} framework provisions {hashicorp-vault-short} and ESO to securely synchronize secrets to the cluster.
