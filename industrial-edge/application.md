...
There will may be times where you need to change the configuration of some of the edge devices in one or more of your factories. In our example, we have various sensors at the factory. Modification can be made to these sensors using `ConfigMaps`. 
 ...
 [![](/images/highleveldemodiagram.png){ .img-thumbnail }](/images/highleveldemodiagram.png)
...
[![](/images/network-routing-line-dashboard.png){ .img-thumbnail }](/images/network-routing-line-dashboard.png)
...
[![](/images/argocd-line-dashboard.png){ .img-thumbnail }](/images/argocd-line-dashboard.png)
...
[![](/images/app-line-dashboard.png){ .img-thumbnail }](/images/app-line-dashboard.png)
