...
Per-pattern cluster sizing on validatedpatterns.io is generated from `pattern-metadata.yaml` in each pattern repository.
Pattern maintainers define tested configurations in that file.
