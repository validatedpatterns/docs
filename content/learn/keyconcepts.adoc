...
Operators generally create their own namespace. But often you may need another different one however you should check and see if there are expected namespaces with the product. 
