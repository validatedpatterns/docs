...
>>>>>>> 6f4d67c21 (TELCODOCS-2143 Updating Medical diags documentation)
----
+
...
[source,terminal]
----
$ python s3-sync-buckets.py -s validated-patterns-md-xray -t mytest-bucket -r us-east-1
----
+
[NOTE]
====
You can do this on the cloud providers console as well.
====
...
+
+
.Example `values-global.yaml` file
+
[source,yaml]
----
 global:
