...
//:imagesdir: ../../images
[id="about-hyp-pattern"]
= About the {hyp-pattern}

Background::

This pattern is designed and intended to assist with simplifying the deployment of an {hyp} Hosting cluster. When this pattern is deployed, users will be be able to create hostedclusters of their own.
