...
[NOTE]
====
For a high-level overview of the `qtodo` demo application and its security features, see xref:/patterns/layered-zero-trust/lzt-data-protection.adoc[Data Protection]. This page provides the detailed technical walkthrough.
====
