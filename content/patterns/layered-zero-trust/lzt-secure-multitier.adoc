...
[NOTE]
====
For a high-level overview of the `qtodo` demo application and its security features, see link:/patterns/layered-zero-trust/lzt-data-protection/[Data Protection]. This page provides the detailed technical walkthrough.
====
